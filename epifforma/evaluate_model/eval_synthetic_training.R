############################################################
############################################################
### epiFFORMA Predictions for Synthetic Training Dataset ###
############################################################
############################################################
...
######################################################
### Read in Training Features and Component Models ###
######################################################
...
comp_ex <- list.files(paste0(savetrainpath,"training_data_packets/"))[grepl("component",list.files(paste0(savetrainpath,"training_data_packets/"))) & 
                                                                        !grepl("components_minusk",list.files(paste0(savetrainpath,"training_data_packets/")))]
component_data <- NULL
