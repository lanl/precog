...
if(scale_ts == 'yes'){
  output_path = '~/GitLab/frodo/evaluations/smoanodiff/sourcespecific'
}else{
  output_path = '~/GitLab/frodo/evaluations/smoanodiff_noscale/sourcespecific'
}

### Get Files to Evaluate ###
FILES_ALL = list.files(paste0(embedding_path))
