...
NUM_RUN = 1
for(i in 1:NUM_RUN){
  cmdLines <- paste0("Rscript --vanilla ",my_path,"/evaluate_gbm_internal.R",
                     " --alpha=0.5",
                     " --total_run=",NUM_RUN,
                     " --cur_run=",i,
                     " --scale_ts=yes")
...
for(i in 1:length(MODES)){
  cmdLines <- paste0("Rscript --vanilla ",my_path,"/evaluate_gbm_internal_modespecific.R",
                     " --alpha=0.5",
                     " --total_run=",1,
                     " --cur_run=",1,
...
for(i in 1:length(DISEASES)){
  cmdLines <- paste0("Rscript --vanilla ",my_path,"/evaluate_gbm_internal_diseasespecific.R",
                     " --alpha=0.5",
                     " --total_run=",1,
                     " --cur_run=",1,
...
for(i in 1:length(DISEASE_SOURCES)){
  cmdLines <- paste0("Rscript --vanilla ",my_path,"/evaluate_gbm_internal_sourcespecific.R",
                     " --alpha=0.5",
                     " --total_run=",1,
                     " --cur_run=",1,
